...
plugins=(git cp colored-man-pages zsh-syntax-highlighting ssh-agent)
...
# Colorful less and grep commands.
export LESSOPEN="| /usr/share/source-highlight/src-hilite-lesspipe.sh %s"
export LESS=' -R '
alias grep="grep --color=always"

# Show both time and memory when using "time MyProgram".
